		...
		<div id="main-info">
			...
			<section id='content' class='bg-black'>
				<div class='inner-content large lift'>
					<h3 class='bg-dark-grey'>You are currenty creating an new Stage</h3>
					<div class='sunday bio padding-medium txt-white txt-left'>

						<form action='?validate=stage' method='post'>
							...
							<table style='width:100%;'>
								...
								<tr>
									<td>Description</td>
									<td><textarea name='description' placeholder='Description' rows='10' style='resize:none;'></textarea></td>
								</tr>
								<tr>
									<td></td>
